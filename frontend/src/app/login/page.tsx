    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col justify-center items-center p-6 relative overflow-hidden">
      <div className="w-full max-w-md z-10 flex flex-col items-center">
        <div className="mb-10 text-center animate-in fade-in zoom-in duration-700">
          ...
          <h1 className="text-3xl font-black tracking-tight mb-2 text-foreground">Sign in</h1>
          <p className="text-muted-foreground font-bold text-xs uppercase tracking-widest">Global Logistics Dashboard</p>
        </div>
        ...
        <div className="w-full bg-card rounded-[2.5rem] border border-border p-10 shadow-xl animate-in slide-in-from-bottom-8 duration-700">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex flex-col gap-6 items-center">
              ...
              <Link href="/register" className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em] hover:text-foreground transition-colors">
                Create account
              </Link>
            </div>
          </form>
